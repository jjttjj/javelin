(ns javelin.destructure
  (:refer-clojure :exclude [destructure]))

;;destructure; needed for bootstrapping cljs

;;adapted from cljs
;;https://github.com/clojure/clojurescript/blob/23cedecbf4f704f9fee672e395bbfa1e3fe3ee1a/src/main/clojure/cljs/core.cljc#L624-L725
...
;;This wrapping is required to work with cljs bootstrapping, not sure why
(defn destructure [b]
  (destructure* b))
